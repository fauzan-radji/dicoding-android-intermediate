package com.fauzan.mygooglemaps
...
import com.fauzan.mygooglemaps.databinding.ActivityMapsBinding
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.setOnMapLongClickListener { latLng ->
            mMap.addMarker(MarkerOptions()
                ...
                .icon(vectorToBitmap(R.drawable.ic_android, Color.parseColor("#BADA55")))
            )
        }
